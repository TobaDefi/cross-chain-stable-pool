...
async function deploy() {
    ...
    const vaultAdminContract: VaultAdmin = await vaultAdmin.connect(deployer).deploy(
        futureVaultAddress,
    ...
    const vaultExtensionContract: VaultExtension = await vaultExtension.connect(deployer).deploy(
        futureVaultAddress,
    ...
    const vaultContract: Vault = await vault.connect(deployer).deploy(
